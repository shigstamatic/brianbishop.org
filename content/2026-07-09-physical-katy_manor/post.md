...
- This is the first real post for the long-running house building project.
- The house project is called Katy Manor.
- This post can introduce the project and set expectations for future updates.
